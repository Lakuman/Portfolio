  ...
  computed: {
    feedbacks() {
      return [
        ...
        {
          name: "Cléo BENZEMA",
          position: this.$t('coworkers.cleo_role'),
          image: "images/pp-cleo.jpg",
          linkedin: "https://www.linkedin.com/in/cl%C3%A9o-benzema-3709172a1/",
          quote: this.$t('coworkers.cleo_text'),
        },
        {
        ...
        {
          name: "Mathias KULHANDJIAN",
          position: this.$t('coworkers.mathias_role'),
          image: "images/pp-mathias.jpg",
          linkedin: "https://www.linkedin.com/in/mathias-kulhandjian-a46782151/",
          quote: this.$t('coworkers.mathias_text'),
        },
        {
          name: "Grégoire HAZETTE",
          position: this.$t('coworkers.gregoire_haz_role'),
          image: "images/pp-greg-haz.jpg",
          linkedin: "https://www.linkedin.com/in/gr%C3%A9goire-hazette-268357165/",
          quote: this.$t('coworkers.gregoire_haz_text'),
        },
        {
          name: "Nathan PARRATT",
          position: this.$t('coworkers.nathan_role'),
          image: "images/pp-nathan.jpg",
          linkedin: "https://www.linkedin.com/in/nathan-parratt/",
          quote: this.$t('coworkers.nathan_text'),
        },
        {
          name: "Grégoire DELZONGUE",
          position: this.$t('coworkers.gregoire_del_role'),
          image: "images/pp-greg-del.jpg",
          linkedin: "https://www.linkedin.com/in/gregoiredelzongle/",
          quote: this.$t('coworkers.gregoire_del_text'),
        },
        {
          name: "Axelle DE GASPERIN",
          position: this.$t('coworkers.axelle_role'),
          image: "images/pp-axelle.jpg",
          linkedin: "https://www.linkedin.com/in/axelle-de-gasperin-59b560a/",
          quote: this.$t('coworkers.axelle_text'),
        },
      ];
    },
  },
